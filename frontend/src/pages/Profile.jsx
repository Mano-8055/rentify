          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="glass rounded-3xl p-6 flex flex-col items-center gap-4">
              ...
              <label className="relative cursor-pointer group">
                <div className="w-24 h-24 rounded-full bg-green-500/20 border-2 border-green-500/30 overflow-hidden flex items-center justify-center">
                  {user.profileImage ? (
                    <img
              ...
              <div className="flex flex-col items-center gap-1">
                ...
                <div className={`mt-8 flex items-center gap-1 text-sm font-semibold ${trust.color}`}>
            ...
            <div className="glass rounded-2xl p-4">
              ...
              {[
                { range: "90–100", label: "Excellent", icon: "🏆", color: "text-yellow-400" },
                { range: "70–89", label: "Good", icon: "✅", color: "text-green-400" },
                { range: "50–69", label: "Fair", icon: "⚠️", color: "text-yellow-500" },
                { range: "30–49", label: "Poor", icon: "🔸", color: "text-orange-400" },
                { range: "0–29", label: "Risky", icon: "🚨", color: "text-red-400" },
              ].map((t) => (
                <div
                  key={t.range}
                  className={`flex items-center justify-between py-1 ${pct >= parseInt(t.range) ? "opacity-100" : "opacity-40"}`}
                >
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <Link to="/rent-history" className="text-xs text-green-400 hover:text-green-300">
                  View all →
                </Link>
              </div>
              ...
              {rentals.length === 0 ? (
                ...
                <div className="flex flex-col gap-3">
                  {rentals.slice(0, 5).map((r) => (
                    <div key={r._id} className="glass rounded-xl p-4 flex items-center gap-3">
